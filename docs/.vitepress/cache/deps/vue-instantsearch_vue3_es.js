    ...
    AlgoliaSearchHelper.prototype.searchForFacetValues = function(facet, query, maxFacetHits, userState) {
      ...
      return searchForFacetValuesPromise.then(
        function addIsRefined(content) {
          ...
          content.facetHits.forEach(function(f12, i6) {
            if (hide.indexOf(f12.value) > -1) {
              content.facetHits.splice(i6, 1);
              return;
            }
...
function S(n6, l4) {
  if (null == l4) return n6.__ ? S(n6.__, n6.__i + 1) : null;
  for (var u5; l4 < n6.__k.length; l4++) if (null != (u5 = n6.__k[l4]) && null != u5.__e) return u5.__e;
  return "function" == typeof n6.type ? S(n6) : null;
}
function C(n6) {
  var l4, u5;
...
function M(n6) {
  (!n6.__d && (n6.__d = true) && i.push(n6) && !$.__r++ || r2 != l.debounceRendering) && ((r2 = l.debounceRendering) || o2)($);
}
function $() {
  for (var n6, u5, t4, r7, o12, f12, c14, s5 = 1; i.length; ) i.length > s5 && i.sort(e2), n6 = i.shift(), s5 = i.length, n6.__d && (t4 = void 0, r7 = void 0, o12 = (r7 = (u5 = n6).__v).__e, f12 = [], c14 = [], u5.__P && ((t4 = d({}, r7)).__v = r7.__v + 1, l.vnode && l.vnode(t4), O(u5.__P, t4, r7, u5.__n, u5.__P.namespaceURI, 32 & r7.__u ? [o12] : null, f12, null == o12 ? S(r7) : o12, !!(32 & r7.__u), c14), t4.__v = r7.__v, t4.__.__k[t4.__i] = t4, N(f12, t4, c14), r7.__e = r7.__ = null, t4.__e != o12 && C(t4)));
  $.__r = 0;
}
function I(n6, l4, u5, t4, i6, r7, o12, e6, f12, c14, s5) {
  var a6, h8, y5, w2, d8, g9, _2, m12 = t4 && t4.__k || v, b3 = l4.length;
  for (f12 = P(u5, l4, m12, f12, b3), a6 = 0; a6 < b3; a6++) null != (y5 = u5.__k[a6]) && (h8 = -1 == y5.__i ? p : m12[y5.__i] || p, y5.__i = a6, g9 = O(n6, y5, h8, i6, r7, o12, e6, f12, c14, s5), w2 = y5.__e, y5.ref && h8.ref != y5.ref && (h8.ref && B(h8.ref, null, y5), s5.push(y5.ref, y5.__c || w2, y5)), null == d8 && null != w2 && (d8 = w2), (_2 = !!(4 & y5.__u)) || h8.__k === y5.__k ? f12 = A(y5, f12, n6, _2) : "function" == typeof y5.type && void 0 !== g9 ? f12 = g9 : w2 && (f12 = w2.nextSibling), y5.__u &= -7);
  return u5.__e = d8, f12;
}
function P(n6, l4, u5, t4, i6) {
  var r7, o12, e6, f12, c14, s5 = u5.length, a6 = s5, h8 = 0;
  for (n6.__k = new Array(i6), r7 = 0; r7 < i6; r7++) null != (o12 = l4[r7]) && "boolean" != typeof o12 && "function" != typeof o12 ? (f12 = r7 + h8, (o12 = n6.__k[r7] = "string" == typeof o12 || "number" == typeof o12 || "bigint" == typeof o12 || o12.constructor == String ? m(null, o12, null, null, null) : w(o12) ? m(k, { children: o12 }, null, null, null) : null == o12.constructor && o12.__b > 0 ? m(o12.type, o12.props, o12.key, o12.ref ? o12.ref : null, o12.__v) : o12).__ = n6, o12.__b = n6.__b + 1, e6 = null, -1 != (c14 = o12.__i = L(o12, u5, f12, a6)) && (a6--, (e6 = u5[c14]) && (e6.__u |= 2)), null == e6 || null == e6.__v ? (-1 == c14 && (i6 > s5 ? h8-- : i6 < s5 && h8++), "function" != typeof o12.type && (o12.__u |= 4)) : c14 != f12 && (c14 == f12 - 1 ? h8-- : c14 == f12 + 1 ? h8++ : (c14 > f12 ? h8-- : h8++, o12.__u |= 4))) : n6.__k[r7] = null;
  if (a6) for (r7 = 0; r7 < s5; r7++) null != (e6 = u5[r7]) && 0 == (2 & e6.__u) && (e6.__e == t4 && (t4 = S(e6)), D(e6, e6));
  return t4;
}
function A(n6, l4, u5, t4) {
  var i6, r7;
  if ("function" == typeof n6.type) {
    for (i6 = n6.__k, r7 = 0; i6 && r7 < i6.length; r7++) i6[r7] && (i6[r7].__ = n6, l4 = A(i6[r7], l4, u5, t4));
    return l4;
  }
  n6.__e != l4 && (t4 && (l4 && n6.type && !l4.parentNode && (l4 = S(n6)), u5.insertBefore(n6.__e, l4 || null)), l4 = n6.__e);
  do {
...
function L(n6, l4, u5, t4) {
  var i6, r7, o12, e6 = n6.key, f12 = n6.type, c14 = l4[u5], s5 = null != c14 && 0 == (2 & c14.__u);
  if (null === c14 && null == n6.key || s5 && e6 == c14.key && f12 == c14.type) return u5;
  if (t4 > (s5 ? 1 : 0)) {
    for (i6 = u5 - 1, r7 = u5 + 1; i6 >= 0 || r7 < l4.length; ) if (null != (c14 = l4[o12 = i6 >= 0 ? i6-- : r7++]) && 0 == (2 & c14.__u) && e6 == c14.key && f12 == c14.type) return o12;
  }
  return -1;
}
function T(n6, l4, u5) {
...
function j(n6, l4, u5, t4, i6) {
  ...
  else if ("o" == l4[0] && "n" == l4[1]) r7 = l4 != (l4 = l4.replace(f, "$1")), o12 = l4.toLowerCase(), l4 = o12 in n6 || "onFocusOut" == l4 || "onFocusIn" == l4 ? o12.slice(2) : l4.slice(2), n6.l || (n6.l = {}), n6.l[l4 + r7] = u5, u5 ? t4 ? u5.u = t4.u : (u5.u = c, n6.addEventListener(l4, r7 ? a2 : s2, r7)) : n6.removeEventListener(l4, r7 ? a2 : s2, r7);
  else {
...
function O(n6, u5, t4, i6, r7, o12, e6, f12, c14, s5) {
  var a6, h8, p6, v6, y5, _2, m12, b3, S2, C2, M2, $2, P3, A2, H, L3, T2, j2 = u5.type;
  if (null != u5.constructor) return null;
  128 & t4.__u && (c14 = !!(32 & t4.__u), o12 = [f12 = u5.__e = t4.__e]), (a6 = l.__b) && a6(u5);
  n: if ("function" == typeof j2) try {
    if (b3 = u5.props, S2 = "prototype" in j2 && j2.prototype.render, C2 = (a6 = j2.contextType) && i6[a6.__c], M2 = a6 ? C2 ? C2.props.value : a6.__ : i6, t4.__c ? m12 = (h8 = u5.__c = t4.__c).__ = h8.__E : (S2 ? u5.__c = h8 = new j2(b3, M2) : (u5.__c = h8 = new x(b3, M2), h8.constructor = j2, h8.render = E), C2 && C2.sub(h8), h8.props = b3, h8.state || (h8.state = {}), h8.context = M2, h8.__n = i6, p6 = h8.__d = true, h8.__h = [], h8._sb = []), S2 && null == h8.__s && (h8.__s = h8.state), S2 && null != j2.getDerivedStateFromProps && (h8.__s == h8.state && (h8.__s = d({}, h8.__s)), d(h8.__s, j2.getDerivedStateFromProps(b3, h8.__s))), v6 = h8.props, y5 = h8.state, h8.__v = u5, p6) S2 && null == j2.getDerivedStateFromProps && null != h8.componentWillMount && h8.componentWillMount(), S2 && null != h8.componentDidMount && h8.__h.push(h8.componentDidMount);
    else {
      if (S2 && null == j2.getDerivedStateFromProps && b3 !== v6 && null != h8.componentWillReceiveProps && h8.componentWillReceiveProps(b3, M2), !h8.__e && null != h8.shouldComponentUpdate && false === h8.shouldComponentUpdate(b3, h8.__s, M2) || u5.__v == t4.__v) {
        for (u5.__v != t4.__v && (h8.props = b3, h8.state = h8.__s, h8.__d = false), u5.__e = t4.__e, u5.__k = t4.__k, u5.__k.some(function(n7) {
          n7 && (n7.__ = u5);
        }), $2 = 0; $2 < h8._sb.length; $2++) h8.__h.push(h8._sb[$2]);
        h8._sb = [], h8.__h.length && e6.push(h8);
        break n;
      }
      null != h8.componentWillUpdate && h8.componentWillUpdate(b3, h8.__s, M2), S2 && null != h8.componentDidUpdate && h8.__h.push(function() {
        h8.componentDidUpdate(v6, y5, _2);
      });
    }
    if (h8.context = M2, h8.props = b3, h8.__P = n6, h8.__e = false, P3 = l.__r, A2 = 0, S2) {
      for (h8.state = h8.__s, h8.__d = false, P3 && P3(u5), a6 = h8.render(h8.props, h8.state, h8.context), H = 0; H < h8._sb.length; H++) h8.__h.push(h8._sb[H]);
      h8._sb = [];
    } else do {
      h8.__d = false, P3 && P3(u5), a6 = h8.render(h8.props, h8.state, h8.context), h8.state = h8.__s;
    } while (h8.__d && ++A2 < 25);
    h8.state = h8.__s, null != h8.getChildContext && (i6 = d(d({}, i6), h8.getChildContext())), S2 && !p6 && null != h8.getSnapshotBeforeUpdate && (_2 = h8.getSnapshotBeforeUpdate(v6, y5)), L3 = a6, null != a6 && a6.type === k && null == a6.key && (L3 = V(a6.props.children)), f12 = I(n6, w(L3) ? L3 : [L3], u5, t4, i6, r7, o12, e6, f12, c14, s5), h8.base = u5.__e, u5.__u &= -161, h8.__h.length && e6.push(h8), m12 && (h8.__E = h8.__ = null);
  } catch (n7) {
    if (u5.__v = null, c14 || null != o12) if (n7.then) {
      ...
      for (T2 = o12.length; T2--; ) g(o12[T2]);
      z(u5);
    }
    else u5.__e = t4.__e, u5.__k = t4.__k, n7.then || z(u5);
    l.__e(n7, u5, t4);
  }
  else null == o12 && u5.__v == t4.__v ? (u5.__k = t4.__k, u5.__e = t4.__e) : f12 = u5.__e = q(t4.__e, u5, t4, i6, r7, o12, e6, c14, s5);
  return (a6 = l.diffed) && a6(u5), 128 & u5.__u ? void 0 : f12;
}
function z(n6) {
  n6 && n6.__c && (n6.__c.__e = true), n6 && n6.__k && n6.__k.forEach(z);
}
function N(n6, u5, t4) {
...
function q(u5, t4, i6, r7, o12, e6, f12, c14, s5) {
  var a6, h8, v6, y5, d8, _2, m12, b3 = i6.props, k5 = t4.props, x3 = t4.type;
  if ("svg" == x3 ? o12 = "http://www.w3.org/2000/svg" : "math" == x3 ? o12 = "http://www.w3.org/1998/Math/MathML" : o12 || (o12 = "http://www.w3.org/1999/xhtml"), null != e6) {
    for (a6 = 0; a6 < e6.length; a6++) if ((d8 = e6[a6]) && "setAttribute" in d8 == !!x3 && (x3 ? d8.localName == x3 : 3 == d8.nodeType)) {
      u5 = d8, e6[a6] = null;
      break;
    }
  }
  ...
  if (null == x3) b3 === k5 || c14 && u5.data == k5 || (u5.data = k5);
    ...
    if (e6 = e6 && n4.call(u5.childNodes), b3 = i6.props || p, !c14 && null != e6) for (b3 = {}, a6 = 0; a6 < u5.attributes.length; a6++) b3[(d8 = u5.attributes[a6]).name] = d8.value;
    for (a6 in b3) if (d8 = b3[a6], "children" == a6) ;
    else if ("dangerouslySetInnerHTML" == a6) v6 = d8;
    else if (!(a6 in k5)) {
      if ("value" == a6 && "defaultValue" in k5 || "checked" == a6 && "defaultChecked" in k5) continue;
      j(u5, a6, null, d8, o12);
    }
    for (a6 in k5) d8 = k5[a6], "children" == a6 ? y5 = d8 : "dangerouslySetInnerHTML" == a6 ? h8 = d8 : "value" == a6 ? _2 = d8 : "checked" == a6 ? m12 = d8 : c14 && "function" != typeof d8 || b3[a6] === d8 || j(u5, a6, d8, b3[a6], o12);
    if (h8) c14 || v6 && (h8.__html == v6.__html || h8.__html == u5.innerHTML) || (u5.innerHTML = h8.__html), t4.__k = [];
    else if (v6 && (u5.innerHTML = ""), I("template" == t4.type ? u5.content : u5, w(y5) ? y5 : [y5], t4, i6, r7, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o12, e6, f12, e6 ? e6[0] : i6.__k && S(i6, 0), c14, s5), null != e6) for (a6 = e6.length; a6--; ) g(e6[a6]);
    c14 || (a6 = "value", "progress" == x3 && null == _2 ? u5.removeAttribute("value") : null != _2 && (_2 !== u5[a6] || "progress" == x3 && !_2 || "option" == x3 && _2 != b3[a6]) && j(u5, a6, _2, b3[a6], o12), a6 = "checked", null != m12 && m12 != u5[a6] && j(u5, a6, m12, b3[a6], o12));
  }
  return u5;
}
function B(n6, u5, t4) {
...
function D(n6, u5, t4) {
  var i6, r7;
  if (l.unmount && l.unmount(n6), (i6 = n6.ref) && (i6.current && i6.current != n6.__e || B(i6, null, u5)), null != (i6 = n6.__c)) {
  ...
  if (i6 = n6.__k) for (r7 = 0; r7 < i6.length; r7++) i6[r7] && D(i6[r7], u5, t4 || "function" != typeof n6.type);
  t4 || g(n6.__e), n6.__c = n6.__ = n6.__e = void 0;
}
function E(n6, l4, u5) {
...
n4 = v.slice, l = { __e: function(n6, l4, u5, t4) {
  ...
  var u5;
  u5 = null != this.__s && this.__s != this.state ? this.__s : this.__s = d({}, this.state), "function" == typeof n6 && (n6 = n6(d({}, u5), this.props)), n6 && d(u5, n6), null != n6 && this.__v && (l4 && this._sb.push(l4), M(this));
...
}, $.__r = 0, f = /(PointerCapture)$|Capture$/i, c = 0, s2 = F(false), a2 = F(true), h2 = 0;
...
function _objectWithoutProperties6(e6, t4) {
  ...
  if (Object.getOwnPropertySymbols) {
    var n6 = Object.getOwnPropertySymbols(e6);
    for (r7 = 0; r7 < n6.length; r7++) o12 = n6[r7], -1 === t4.indexOf(o12) && {}.propertyIsEnumerable.call(e6, o12) && (i6[o12] = e6[o12]);
  }
  return i6;
}
      ...
      started: function started() {
        ...
        if (isModernInsightsClient(insightsClient)) {
          insightsClientWithLocalCredentials = function insightsClientWithLocalCredentials2(method, payload) {
            var _getAppIdAndApiKey3 = getAppIdAndApiKey(instantSearchInstance.client), _getAppIdAndApiKey4 = _slicedToArray12(_getAppIdAndApiKey3, 2), latestAppId = _getAppIdAndApiKey4[0], latestApiKey = _getAppIdAndApiKey4[1];
            var extraParams = {
              headers: {
...
var InstantSearch = function(_EventEmitter) {
  ...
  function InstantSearch2(options) {
    ...
    _defineProperty45(_assertThisInitialized(_this), "_manuallyResetScheduleSearch", false);
    _defineProperty45(_assertThisInitialized(_this), "_resetScheduleSearch", void 0);
